...
LIBTCCAPI int tcc_run(TCCState *s1, int argc, char **argv)
{
    ...
    static const builtin_sym_t default_runtime_syms[] = {
        {"printf", (const void *)printf},
        {"sprintf", (const void *)sprintf},
        {"snprintf", (const void *)snprintf},
        {"vprintf", (const void *)vprintf},
        {"vsprintf", (const void *)vsprintf},
        {"vsnprintf", (const void *)vsnprintf},
        {"fprintf", (const void *)fprintf},
        {"vfprintf", (const void *)vfprintf},
        {"putchar", (const void *)putchar},
        {"puts", (const void *)puts},
        {"fputc", (const void *)fputc},
        {"putc", (const void *)putc},
        {"fputs", (const void *)fputs},
        {"fgetc", (const void *)fgetc},
        {"getc", (const void *)getc},
        {"fgets", (const void *)fgets},
        {"ungetc", (const void *)ungetc},
        {"fopen", (const void *)fopen},
        {"fclose", (const void *)fclose},
        {"fread", (const void *)fread},
        {"fwrite", (const void *)fwrite},
        {"fseek", (const void *)fseek},
        {"ftell", (const void *)ftell},
        {"feof", (const void *)feof},
        {"ferror", (const void *)ferror},
        {"fflush", (const void *)fflush},
        {"remove", (const void *)remove},
        {"open", (const void *)open},
        {"close", (const void *)close},
        {"read", (const void *)read},
        {"write", (const void *)write},
        {"lseek", (const void *)lseek},
        {"unlink", (const void *)unlink},
        {"stat", (const void *)stat},
        {"fstat", (const void *)fstat},
        {"malloc", (const void *)malloc},
        {"free", (const void *)free},
        {"realloc", (const void *)realloc},
        {"calloc", (const void *)calloc},
        {"exit", (const void *)exit},
        {"abort", (const void *)abort},
        {"atoi", (const void *)atoi},
        {"strtol", (const void *)strtol},
        {"strtoul", (const void *)strtoul},
        {"strtoll", (const void *)strtoll},
        {"strtoull", (const void *)strtoull},
        {"strtod", (const void *)strtod},
        {"strtof", (const void *)strtof},
        {"strtold", (const void *)strtold},
        {"strlen", (const void *)strlen},
        {"strcpy", (const void *)strcpy},
        {"strncpy", (const void *)strncpy},
        {"strcat", (const void *)strcat},
        {"strncat", (const void *)strncat},
        {"strcmp", (const void *)strcmp},
        {"strncmp", (const void *)strncmp},
        {"strchr", (const void *)strchr},
        {"strrchr", (const void *)strrchr},
        {"strstr", (const void *)strstr},
        {"strdup", (const void *)strdup},
        {"memcpy", (const void *)memcpy},
        {"memmove", (const void *)memmove},
        {"memset", (const void *)memset},
        {"memcmp", (const void *)memcmp},
        {"memchr", (const void *)memchr},
        {"time", (const void *)time},
        {"localtime", (const void *)localtime},
        {"gettimeofday", (const void *)gettimeofday},
        {"qsort", (const void *)qsort},
        {"stdin", (const void *)&stdin},
        {"stdout", (const void *)&stdout},
        {"stderr", (const void *)&stderr},
        {"errno", (const void *)&errno},
        {NULL, NULL}
    };

    for (int i = 0; default_runtime_syms[i].name != NULL; i++) {
        tcc_add_symbol(s1, default_runtime_syms[i].name, default_runtime_syms[i].addr);
    }
