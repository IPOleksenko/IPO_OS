...
REQUIRED_PACKAGES=("build-essential" "bison" "flex" "libgmp3-dev" "libmpc-dev" "libmpfr-dev" "texinfo" "qemu-system-x86" "xorriso" "grub-pc-bin" "python3" "python3-pip" "python3-venv" "automake" "autoconf")
...
echo "Setting up cross-compiler for $TARGET..."
